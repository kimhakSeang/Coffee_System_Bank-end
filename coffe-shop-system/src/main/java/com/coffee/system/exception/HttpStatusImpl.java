...
public enum HttpStatusImpl {
	
	
	    NOT_FOUND(404, Series.CLIENT_ERROR, "Not Found"),
	    
	    INSERT_FAIL(405, Series.CLIENT_ERROR, "Insert Fail"),
	    
	    UPDATE_FAIL(406, Series.CLIENT_ERROR, "Update Fail"),
	    
	    DELETE_FAIL(407, Series.CLIENT_ERROR, "Delete Fail"),
		...
		HttpStatusImpl(int value, Series series, String reasonPhrase) {
			this.value = value;
			this.series = series;
